      ...
      <div className='join_form'>
        <form onSubmit={handleJoin}>
          ...
          <div className='form_div'>
            ...
            <input className='input' type="email" id="email" name="email" placeholder="Email" value={email} onChange={handleEmailChange} onBlur={handleEmailBlur} disabled={isValidEPw&&true} required/>
          ...
          <div className='form_div'>
            <label className='label' htmlFor="ePw">인증번호 </label>
            <input className='input' type="text" id="ePw" name="ePw" placeholder="인증번호 입력" value={ePw} onChange={handleEPwChange} disabled={isValidEPw&&true} required/>
            {isTimer && !isValidEPw ? (
                    <Timer/>
                  ) : null}
          ...
          <div className='form_div'>
            ...
            <input className='input' type="password" id="password" name="password" placeholder="Password" value={password} onChange={handlePasswordChange} required/> <br />
            <span className={isValidPwd ? 'success' : 'error'}>{pwdMsg}</span>
          </div>
          
          <div className='form_div'>
            <label className='label' htmlFor="repassword">비밀번호 확인 </label>
            <input className='input' type="password" id="repassword" name="repassword" placeholder="RePassword" value={repassword} onChange={handleRePasswordChange} required/> <br />
            <span className={isValidRePwd ? 'success' : 'error'}>{rePwdMsg}</span>
          </div>
          
          <div className='form_div'> 
            <label className='label' htmlFor="nickName">닉네임 </label>
            <input className='input' type="text" id="nickName" name="nickName" placeholder="NickName" value={nickName} onChange={handleNickNameChange} onBlur={handleNickNameBlur} required/> <br />
